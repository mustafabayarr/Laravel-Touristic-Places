...
class FaqController extends Controller
{
    ...
    {
        $datalist = Faq::all();
        return view('back.faq',['datalist' => $datalist]);
    }
    ...
    {
        $datalist = Faq::all();
        return view('back.faq_add', ['datalist' => $datalist]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return redirect()->route('admin_faq')->with('success','Added FAQ');
    }
    ...
    {
        $data = Faq::find($id);
        return view('back.faq_edit',['data' => $data]);
    }
