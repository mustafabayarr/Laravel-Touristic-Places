...
class ImageController extends Controller
{
    ...
    public function create($places_id)
    {
       ...
       //$images_list = Image::all();
        ...
        return view('back.image_add',['image'=>$image,'images_list'=>$images_list]);
    }
    ...
    public function store(Request $request,$places_id)
    {
        ...
        $image_add->save();
        return redirect()->route('admin_image_create',['places_id' => $places_id]);
    }
    ...
    public function destroy(Image $image,$id,$places_id)
    {
       ...
       // DB::table('images')->where('id', '=', $id)->delete();
        return redirect()->route('admin_image_create',['id' => $id,'places_id' => $places_id]);
    }
}
